        ...
        <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-white glow-white" />
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/start">
              <Button className="h-9 px-6 bg-white text-black hover:bg-zinc-200 rounded-none font-bold tracking-wide text-xs btn-glow">
                LAUNCH APP
              </Button>
            </Link>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <ScrollReveal direction="up" delay={100}>
            <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-none">
              <GradientText animate={true}>METADATA</GradientText> <br />
          ...
          <ScrollReveal direction="up" delay={300}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
              <Link href="/start" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto h-14 px-10 bg-white text-black hover:bg-zinc-200 rounded-none font-bold tracking-widest text-sm btn-glow glow-white">
                  INITIALIZE
                </Button>
              </Link>
              <Link href="/docs" className="w-full sm:w-auto">
                <Button variant="outline" className="w-full sm:w-auto h-14 px-10 border-white/20 bg-transparent hover:bg-white/5 text-white rounded-none font-mono text-xs neon-border">
                  READ_DOCS
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
          {[
            ...
            <ScrollReveal key={i} delay={i * 150} direction="up">
              <TiltCard>
                <div className="p-12 hover:bg-white/5 transition-all group cursor-default feature-card">
                  <h3 className="text-sm font-mono text-zinc-500 mb-4 group-hover:text-purple-400 transition-colors">{item.title}</h3>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <ScrollReveal direction="left">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/explorer" className="text-xs font-mono text-zinc-500 hover:text-purple-400 transition-colors">
                VIEW ALL →
              </Link>
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <ScrollReveal direction="left" className="lg:col-span-1 order-2 lg:order-1">
              ...
              <div className="border border-white/10 bg-zinc-950/80 max-h-[400px] overflow-y-auto card-glow">
                <ActivityFeed />
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right" className="lg:col-span-2 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  <TiltCard key={i}>
                    <Link href={item.href} className="group border border-white/10 p-6 hover:border-purple-500/50 transition-all block feature-card">
                      <div className="w-10 h-10 bg-zinc-900 flex items-center justify-center mb-3 group-hover:bg-purple-500/20 group-hover:glow-purple transition-all">
                        <svg className="w-5 h-5 text-zinc-400 group-hover:text-purple-400 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                          {item.icon}
                        </svg>
                      </div>
